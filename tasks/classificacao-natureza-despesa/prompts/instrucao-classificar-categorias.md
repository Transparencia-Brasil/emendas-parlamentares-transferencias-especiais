...
Caso o texto do plano de trabalho possua as seguintes palavras ou sinônimos: construções, reformas, ampliações, pavimentação, instalações físicas → "Obra/instalação".
**Ex.:** Construção de escola, Reforma de UBS, Pavimentação asfáltica.

### 2. Equipamentos/material permanente

Caso o texto do plano de trabalho possua as seguintes palavras ou sinônimos: bens duráveis, máquinas, veículos, mobiliário, equipamentos hospitalares → "Equipamentos/material permanente".
**Ex.:** Ambulâncias, Equipamentos odontológicos, Computadores.

### 3. Serviços

Caso o texto do plano de trabalho possua as seguintes palavras ou sinônimos: contratações de terceiros, consultoria, manutenção, capacitação, estudos → "Serviços".
**Ex.:** Manutenção predial, Capacitação de servidores, Consultoria técnica.

### 4. Material de consumo

Caso o texto do plano de trabalho possua as seguintes palavras ou sinônimos: insumos, medicamentos, combustíveis, material de escritório, uniformes → "Material de consumo".
...
- **Classificação orçamentária (quando disponível)**:
  - Despesas de capital/investimento → geralmente indicam obras (categoria "Obra/instalação") ou equipamentos permanentes (categoria "Equipamentos/material permanente")
  - Despesas correntes/custeio → geralmente indicam serviços (categoria "Serviços") ou material de consumo (categoria "Material de consumo")
...
- `categoria` (valores "Obra/instalação", "Equipamentos/material permanente", "Serviços", "Material de consumo" ou "Não identificado")

### Exemplo de saída

| objeto_executor              | desc_meta                | categoria                          |
| ---------------------------- | ------------------------ | ---------------------------------- |
| Construção de UBS            | Construir 1 unidade      | "Obra/instalação"                  |
| Aquisição de ambulâncias     | Comprar 2 veículos       | "Equipamentos/material permanente" |
| Contratação de limpeza       | Manter limpeza predial   | "Serviços"                         |
| Distribuição de medicamentos | Fornecer 1000 doses      | "Material de consumo"              |
| Apoio institucional          | Desenvolvimento de ações | "Não identificado"                 |
